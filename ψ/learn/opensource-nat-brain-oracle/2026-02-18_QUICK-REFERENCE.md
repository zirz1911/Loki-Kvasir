...
| # | Principle | Meaning |
|---|-----------|---------|
| 1 | **Nothing is Deleted** | Append-only. Timestamps are truth. All decisions traceable. |
...
```
active/ → /snapshot → logs/ → rrr → retrospectives/ → /distill → learnings/ → resonance/
```

## Key Insights

- **Add:Delete Ratio = 14.8:1** — Nat is a builder, not a destroyer
